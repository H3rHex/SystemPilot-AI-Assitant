...
STATUS_EXECUTING = "[bold gold3]⚙️  Executing...[/bold gold3] [dim]Running core system operation[/dim]"

# 4. Process Termination Messages
EXIT_MESSAGE_CLEAN = "\n[bold spring_green3]✔[/bold spring_green3] [bold white]Exiting SystemPilot securely.[/bold white] Goodbye! 👋\n"
EXIT_MESSAGE_INTERRUPT = "\n\n[bold orange3]⚠️  Session forcefully interrupted by user.[/bold orange3] Exiting application loop...\n"
